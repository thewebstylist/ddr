...
Self-contained web design templates. Each one is a directory with its own README, no build
step required to look at it, and a script that flattens it into a single droppable HTML file.
